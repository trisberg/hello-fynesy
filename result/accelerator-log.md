...
{
  "bsGitBranch" : "main",
  "projectName" : "hello-fynesy",
  "deploymentType" : "workload",
  "includeBuildToolWrapper" : true,
  "bsGitRepository" : "github.com?owner=trisberg&repo=hello-fynesy"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [hello-fun->hello-fynesy]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=trisberg&repo=hello-fynesy'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [hello-fun template repo->hello-fynesy]
